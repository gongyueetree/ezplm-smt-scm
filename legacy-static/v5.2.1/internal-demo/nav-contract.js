...
(function () {
  ...
  var ALIAS = {
    'bom.html': 'bom-process', 'bom-detail.html': 'bom-process',
    'po-create.html': 'procurement', 'po-detail.html': 'procurement', 'po-import.html': 'procurement',
    'supplier.html': 'opo', 'slow-moving.html': 'procurement',
    'material.html': 'master-data', 'material-detail.html': 'master-data',
    'architecture.html': 'phase2', 'plan.html': 'phase2', 'part-brain.html': 'phase2',
    'substitute-rules.html': 'price-compare',
    'ecn.html': 'phase2', 'ecn-detail.html': 'phase2', 'iqc.html': 'phase2',
    'complaint.html': 'phase2', 'rohs.html': 'phase2', 'customer-letter.html': 'phase2',
    'workflow-metrics.html': 'phase2',
  };
  ...
  // ---------- 横幅配置 ----------
  // 超范围页面（仅演示，二期/变更需求）— 仅内部演示版使用
  var OOS_PAGES = {
    'ecn.html': 'ECN/ECO 全流程', 'ecn-detail.html': 'ECN/ECO 全流程',
    'iqc.html': 'IPQC/OQC/SPC 等质量全流程', 'complaint.html': '8D/PDCA 客诉全流程',
    'rohs.html': '环保合规附件库与到期提醒', 'customer-letter.html': 'ECN 客户告知信（随 ECN 列入二期）',
    'part-brain.html': '元器件知识图谱（PartBrain）', 'workflow-metrics.html': '工作流 SLA 指标看板',
    'architecture.html': '平台远期架构总览',
    'bom.html': '旧版 BOM 页（本期由 BOM 智能处理替代）', 'bom-detail.html': '旧版 BOM 详情（含超范围 AI 风险标注）',
    'material.html': '批次/MSL 深度管理（本期仅基础物料主数据）',
    'material-detail.html': '批次/MSL 深度管理（本期仅基础物料主数据）',
    'plan.html': '旧版排产页（本期由计划辅助替代，APS 为二期）',
    'po-create.html': '旧版 PO 流程（本期为采购申请辅助）', 'po-detail.html': '旧版 PO 流程',
    'po-import.html': '旧版 PO 导入', 'slow-moving.html': 'Excess 跨客户转料（本期仅内部呆滞提醒，见采购助手）',
    'substitute-rules.html': '深度 AVL 替代规则治理（本期替代建议见多源比价页）',
  };
