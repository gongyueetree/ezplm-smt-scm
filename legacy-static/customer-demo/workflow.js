    ...
    wxToast.innerHTML = `
      ...
      <div style="flex: 1; min-width: 0;">
        <div style="display: flex; align-items: center; gap: 6px; margin-bottom: 4px;">
          <span style="font-size: 12px; font-weight: 700; color: var(--gray-900);">企业微信 · ezPLM 助手</span>
        ...
        <div style="margin-top: 6px; font-size: 10px; color: var(--gray-400);">通过 Webhook 推送到「ezPLM 审批」企业微信群</div>
      </div>
